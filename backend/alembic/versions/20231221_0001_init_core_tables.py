...
def upgrade() -> None:
    role_enum = sa.Enum("admin", "compras", "vendas", "financeiro", name="rolename")
    order_status_enum = sa.Enum("draft", "submitted", "hedged", "settled", name="orderstatus")
    hedge_status_enum = sa.Enum("planned", "rfq", "executed", "closed", name="hedgestatus")
    hedge_type_enum = sa.Enum("purchase", "sale", name="hedgetype")
    hedge_side_enum = sa.Enum("buy", "sell", name="hedgeside")
    rfq_status_enum = sa.Enum("draft", "sent", "quoted", "awarded", "expired", name="rfqstatus")
    rfq_type_enum = sa.Enum("hedge_buy", "hedge_sell", name="rfqtype")
    market_obj_enum = sa.Enum("hedge", "po", "so", "portfolio", name="marketobjecttype")
