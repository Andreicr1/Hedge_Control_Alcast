...
revision = "20250110_0005"
down_revision = "20250110_0004"
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.alter_column("hedges", "so_id", existing_type=sa.Integer(), nullable=True)


def downgrade() -> None:
    op.alter_column("hedges", "so_id", existing_type=sa.Integer(), nullable=False)
