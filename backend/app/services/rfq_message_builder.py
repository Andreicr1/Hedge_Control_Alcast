...
from app.services.rfq_engine import generate_rfq_text, RfqTrade, Leg, TradeType, Side, PriceType


def build_rfq_message(rfq: models.Rfq, counterparty: models.Counterparty, lme_text: str | None = None) -> str:
