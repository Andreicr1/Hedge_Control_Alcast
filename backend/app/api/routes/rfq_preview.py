...
from app.schemas.rfq_preview import RfqPreviewRequest, RfqPreviewResponse, LegInput
...
def preview_rfq(payload: RfqPreviewRequest) -> RfqPreviewResponse:
    ...
    try:
        ...
        raise HTTPException(status_code=status.HTTP_500_INTERNAL_SERVER_ERROR, detail="RFQ preview failed") from exc
