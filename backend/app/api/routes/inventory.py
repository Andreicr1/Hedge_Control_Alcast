...
def list_inventory(
    ...
    query = query.filter(models.PurchaseOrder.status != models.OrderStatus.settled)
    ...
    committed_data = {
        ...
        for row in (
            db.query(
                ...
                func.sum(
                    func.coalesce(models.SalesOrder.quantity_tons, 0) * func.coalesce(models.SoPoLink.link_ratio, 1.0)
