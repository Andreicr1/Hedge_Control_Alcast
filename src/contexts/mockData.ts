  ...
  counterparties: [
    {
      ...
      name: 'Itaú BBA',
      trade_name: 'Itaú BBA',
      legal_name: 'Banco Itaú BBA S.A.',
      type: CounterpartyType.BANK,
      entity_type: 'financial_institution',
      country_incorporation: 'BR',
      country_operation: 'BR',
      tax_id_type: 'CNPJ',
      tax_id_value: '60.746.948/0001-12',
      tax_id_country: 'BR',
      base_currency: 'BRL',
    ...
    },
    {
      ...
      trade_name: 'XP',
      legal_name: 'XP Investimentos S.A.',
      type: CounterpartyType.BROKER,
      entity_type: 'financial_institution',
      country_incorporation: 'BR',
      country_operation: 'BR',
      tax_id_type: 'CNPJ',
      tax_id_value: '02.332.886/0001-04',
      tax_id_country: 'BR',
      base_currency: 'BRL',
  ...
  rfqs: [
    {
      ...
      created_at: now,
      invitations: [
        { id: 1, counterparty_id: 1, counterparty_name: 'Itaú BBA', status: 'sent', sent_at: now },
        { id: 2, counterparty_id: 2, counterparty_name: 'XP Investimentos', status: 'sent', sent_at: now },
      ],
      counterparty_quotes: [
        {
          id: 1,
